...
SELECT o.orderID, o.custID, o.empID, o.orderDate FROM sales.orders o WHERE o.custID IN (
SELECT TOP (1) WITH TIES o1.custID FROM sales.orders o1 
GROUP BY o1.custID ORDER BY COUNT(o1.orderID) DESC);
...
SELECT e.empID, e.firstName, e.lastName FROM HR.employees as e WHERE e.empID NOT IN (
...
SELECT DISTINCT s.country FROM sales.customers s WHERE country NOT IN (
